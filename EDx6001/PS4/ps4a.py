...
WORDLIST_FILENAME = "C:/GitHub/Python_Tuturials/EDx6001/PS4/words.txt"
...
def getWordScore(word, n):
    ...
    for letter in word:
        ...
        # print "%s has a value of %d, giving a score of %d" % (letter, SCRABBLE_LETTER_VALUES[letter], score)
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    print "Goodbye! Total score is %s" % total_score
